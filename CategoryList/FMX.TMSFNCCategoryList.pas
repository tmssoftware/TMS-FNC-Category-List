...
uses
  Classes, FMX.TMSFNCTypes, FMX.TMSFNCGraphics, FMX.TMSFNCGraphicsTypes,
  FMX.TMSFNCCustomControl, FMX.TMSFNCBitmapContainer, FMX.TMSFNCPopup, FMX.Controls
  {$IFNDEF LCLWEBLIB}
...
type
  ...
  {$ELSE}
  TTMSFNCCategoryListDisplayList = TList<TTMSFNCCategoryListDisplayItem>;
  {$ENDIF}
...
uses
  Math, FMX.TMSFNCUtils, FMX.TMSFNCStyles
  {$IFDEF FMXLIB}
  , FMX.Types
  {$ENDIF}
  ;
...
procedure TTMSFNCCustomCategoryList.RepaintItems;
begin
  Repaint;
end;
...
constructor TTMSFNCCategoryListItem.Create(Collection: TCollection);
begin
  inherited;
